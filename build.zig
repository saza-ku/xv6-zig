...
pub fn build(b: *Builder) void {
    ...
    const run_cmd_str = &[_][]const u8{ "qemu-system-i386", "-monitor", "stdio", "-drive", "file=zig-out/bin/disk.iso,index=0,media=disk,format=raw", "-m", "512", "-smp", "1", "-no-shutdown", "-no-reboot" };
